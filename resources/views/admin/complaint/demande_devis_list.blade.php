            ...
            <table class="table datatable table-responsive">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="email">{{$complaint->devis->user->email}}</td>
                  <td class="nom">{{$complaint->devis->user->name}}</td>
                  <td class="pays">{{$complaint->devis->user->pays}}</td>
                  <td class="phone">{{$complaint->devis->user->full_number}}</td>
                  <td class="lang hidden">{{$complaint->devis->user->lang}}</td>
                  <td class="devis"> <a href="{{route('admin.devis.detail', ['id' => $complaint->devis->id])}}">{{$complaint->devis->ref}}</a></td>
