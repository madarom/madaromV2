<div class="modal fade" id="modal-complaint" tabindex="-1">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form class="complaint-form" novalidate method="POST" action="{{route('demande-devis.complaint')}}">
      {{ csrf_field() }}
      <div class="modal-body">
      <input type="hidden" id="demande_devis_id" name="demande_devis_id">
      <div class="ipt-rgstr">
...
<script type="text/javascript">
  $(document).ready(function(){
    $('.complaint').on('click', function(event){
      ...
      $('#demande_devis_id').val($(this).attr('data-id'));
